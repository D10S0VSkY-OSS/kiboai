...
This section demonstrates how to use observability tools with Kibo AI.

## Langfuse Integration
Location: `examples/observability/langfuse_example.py`

This example shows how to integrate Langfuse for observability, tracing, and monitoring of your AI agents. It demonstrates how to initialize the Langfuse client and use it to track agent interactions.
...
```bash
uv run examples/observability/langfuse_example.py
```
